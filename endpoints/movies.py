...
movies = {
    ...
    "6": {
        ...
        "rating": 8.3,
        "actors": ["Сергей Бодров мл.", "Виктор Сухоруков", "Ирина Салтыкова", "Александр Дьяченко"],
    ...
    "7": {
        ...
        "rating": 7.5,
        "actors": ["Константин Хабенский", "Владимир Меньшов", "Мария Порошина", "Виктор Вержбицкий"],
    ...
    "8": {
        ...
        "rating": 7.8,
        "actors": ["Фёдор Бондарчук", "Алексей Серебряков", "Михаил Пореченков", "Артур Смольянинов"],
