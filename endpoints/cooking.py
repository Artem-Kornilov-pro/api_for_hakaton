...
dishes = {
    ...
    "11": {
        ...
        "ingredients": ["тесто для пиццы", "томатный соус", "моцарелла", "базилик", "оливковое масло", "соль"],
        "calories": 250,
    ...
    "12": {
        ...
        "ingredients": ["листы лазаньи", "фарш мясной", "томаты", "лук", "морковь", "соус бешамель", "пармезан"],
        "calories": 350,
        "cooking_time_minutes": 60,
    ...
    "13": {
        ...
        "ingredients": ["рис арборио", "бульон", "лук", "белое вино", "пармезан", "сливочное масло", "грибы"],
        "calories": 280,
        "cooking_time_minutes": 30,
    ...
    "14": {
        ...
        "ingredients": ["маскарпоне", "печенье савоярди", "кофе эспрессо", "яйца", "сахар", "какао"],
        "calories": 380,
        "cooking_time_minutes": 40,
    ...
    "17": {
        ...
        "ingredients": ["лук репчатый", "говяжий бульон", "сыр грюйер", "багет", "сливочное масло", "тимьян"],
        "calories": 180,
        "cooking_time_minutes": 60,
    ...
    "18": {
        ...
        "ingredients": ["мука", "масло сливочное", "яйца", "сливки", "бекон", "сыр", "мускатный орех"],
        "calories": 320,
        "cooking_time_minutes": 50,
    ...
    "19": {
        ...
        "ingredients": ["утиные ножки", "утиный жир", "чеснок", "тимьян", "соль", "перец", "лавровый лист"],
        "calories": 350,
        "cooking_time_minutes": 180,
    ...
    "20": {
        ...
        "ingredients": ["миндальная мука", "сахарная пудра", "яичные белки", "сахар", "сливочный крем"],
        "calories": 120,
        "cooking_time_minutes": 90,
    ...
    "21": {
        ...
        "ingredients": ["кукурузные лепёшки", "говядина", "лук", "кинза", "лайм", "острый соус", "сыр"],
        "calories": 220,
        "cooking_time_minutes": 30,
    ...
    "23": {
        ...
        "ingredients": ["кокосовое молоко", "креветки", "грибы", "лемонграсс", "каффир-лайм", "чили", "рыбный соус"],
        "calories": 180,
        "cooking_time_minutes": 40,
    ...
    "24": {
        ...
        "ingredients": ["рисовая лапша", "креветки", "тофу", "яйца", "ростки бобов", "арахис", "рыбный соус"],
        "calories": 320,
    ...
    "26": {
        ...
        "ingredients": ["баклажаны", "картофель", "фарш бараний", "томаты", "лук", "соус бешамель", "сыр"],
        "calories": 380,
        "cooking_time_minutes": 90,
